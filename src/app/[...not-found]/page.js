...
export default function NotFound({ error, reset }) {
  ...
  return (
    <main className="flex my-16">
      <section className="devCards--container flex bg-brand-primary/60 border-gray-800 border rounded-lg mb-6 mx-auto md:max-w-3xl xl:max-w-6xl">
        <div className="flex-col px-5 py-8 items-center mx-auto max-w-6xl bg-gray-200/5 rounded-lg md:px-48 md:py-16">
          ...
          <Link href="/" className="flex justify-center font-primary text-xl">
